...
enum LegalLinks {
    static let privacy = URL(string: "https://doodleduoapp.com/privacy")!
    static let terms = URL(string: "https://doodleduoapp.com/terms")!
}
...
final class SubscriptionManager: ObservableObject {
    ...
    enum Plan: String, CaseIterable {
        case monthly = "com.doodleduo.pro.monthly"
        case yearly = "com.doodleduo.pro.yearly"
